...
Your town infrastructure supports both economy and aggression: classic fortifications, resource and market development, and a full recruitment ladder from the **Ice Cache** to the **Heart of Coldness**. Signature structures such as the **Skulls of Furies**, **Teleport Zone**, and the ultimate **Lord of Frost** emphasize Tartarus identity-mobility between strongholds, pressure-oriented tempo, and overwhelming late-game scaling.

Magic remains central to the faction’s identity. Tartarus heroes and units lean into ice-themed spellcraft, battlefield manipulation, and Demonic Blood synergies that amplify combat stats and tempo in prolonged engagements. In practiced hands, Tartarus can pivot between fast skirmishing strikes and disciplined, high-value attrition.

---

When **Tartarus** and the **New terrains** package is enabled together, the default native terrain switches to **Iceland**, otherwise the default terrain remains **Snow**.
If **Tides of War** is enabled, Tartarus integrations use the alternative creatures **Sukkub** and **Lilim**.
